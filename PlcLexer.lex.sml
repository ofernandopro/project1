...
\\044\043\003\003\003\003\041\003\040\039\038\037\036\034\003\033\
\\031\031\031\031\031\031\031\031\031\031\030\029\027\026\003\003\
...
\\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\
\\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\
\\032\032\032\032\032\032\032\032\032\032\000\000\000\000\000\000\
\\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\
\\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\
\\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\
\\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\
...
{fin = [], trans = 1},
{fin = [(N 74)], trans = 0},
{fin = [(N 55),(N 74)], trans = 0},
{fin = [(N 70),(N 74)], trans = 0},
{fin = [(N 53),(N 74)], trans = 0},
{fin = [(N 29),(N 74)], trans = 7},
{fin = [(N 29)], trans = 7},
{fin = [(N 29),(N 74)], trans = 9},
{fin = [(N 29)], trans = 10},
{fin = [(N 29)], trans = 11},
...
{fin = [(N 29)], trans = 18},
{fin = [(N 29)], trans = 11},
{fin = [(N 29),(N 74)], trans = 20},
{fin = [(N 29)], trans = 21},
{fin = [(N 29)], trans = 22},
{fin = [(N 29)], trans = 11},
{fin = [(N 51),(N 74)], trans = 0},
{fin = [(N 49),(N 74)], trans = 0},
{fin = [(N 41),(N 74)], trans = 0},
{fin = [(N 57),(N 74)], trans = 27},
{fin = [(N 65)], trans = 0},
{fin = [(N 43),(N 74)], trans = 0},
{fin = [(N 31),(N 74)], trans = 0},
{fin = [(N 7),(N 74)], trans = 31},
{fin = [(N 7)], trans = 31},
{fin = [(N 39),(N 74)], trans = 0},
{fin = [(N 35),(N 74)], trans = 34},
{fin = [(N 68)], trans = 0},
{fin = [(N 72),(N 74)], trans = 0},
{fin = [(N 33),(N 74)], trans = 0},
{fin = [(N 37),(N 74)], trans = 0},
{fin = [(N 47),(N 74)], trans = 0},
{fin = [(N 45),(N 74)], trans = 0},
{fin = [(N 74)], trans = 41},
{fin = [(N 62)], trans = 0},
{fin = [(N 59),(N 74)], trans = 0},
{fin = [(N 4),(N 74)], trans = 44},
{fin = [(N 4)], trans = 44},
{fin = [(N 1)], trans = 0}])
end
...
| 33 => (PLUS(yypos, yypos))
| 35 => (MINUS(yypos, yypos))
| 37 => (MULT(yypos, yypos))
| 39 => (DIV(yypos, yypos))
| 4 => (lex())
| 41 => (EQ(yypos, yypos))
| 43 => (SEMIC(yypos, yypos))
| 45 => (LPAR(yypos, yypos))
| 47 => (RPAR(yypos, yypos))
| 49 => (LSBRACKET(yypos, yypos))
| 51 => (RSBRACKET(yypos, yypos))
| 53 => (LCBRACES(yypos, yypos))
| 55 => (RCBRACES(yypos, yypos))
| 57 => (LESS(yypos, yypos))
| 59 => (NEGATION(yypos, yypos))
| 62 => (AND(yypos, yypos))
| 65 => (LESSEQUAL(yypos, yypos))
| 68 => (ARROW(yypos, yypos))
| 7 => let val yytext=yymktext() in CINT(strToInt(yytext), yypos, yypos) end
| 70 => (PIPE(yypos, yypos))
| 72 => (COMMA(yypos, yypos))
| 74 => let val yytext=yymktext() in error("\n *** Lexer error: character invalid ***\n "); raise
