...
\\045\044\003\003\003\003\042\003\041\040\039\038\037\035\003\034\
\\032\032\032\032\032\032\032\032\032\032\030\029\027\026\003\003\
...
{fin = [], trans = 1},
{fin = [(N 77)], trans = 0},
{fin = [(N 55),(N 77)], trans = 0},
{fin = [(N 70),(N 77)], trans = 0},
{fin = [(N 53),(N 77)], trans = 0},
{fin = [(N 29),(N 77)], trans = 7},
{fin = [(N 29)], trans = 7},
{fin = [(N 29),(N 77)], trans = 9},
{fin = [(N 29)], trans = 10},
{fin = [(N 29)], trans = 11},
...
{fin = [(N 29)], trans = 18},
{fin = [(N 29)], trans = 11},
{fin = [(N 29),(N 77)], trans = 20},
{fin = [(N 29)], trans = 21},
{fin = [(N 29)], trans = 22},
{fin = [(N 29)], trans = 11},
{fin = [(N 51),(N 77)], trans = 0},
{fin = [(N 49),(N 77)], trans = 0},
{fin = [(N 41),(N 77)], trans = 0},
{fin = [(N 57),(N 77)], trans = 27},
{fin = [(N 65)], trans = 0},
{fin = [(N 43),(N 77)], trans = 0},
{fin = [(N 31),(N 77)], trans = 30},
{fin = [(N 75)], trans = 0},
{fin = [(N 7),(N 77)], trans = 32},
{fin = [(N 7)], trans = 32},
{fin = [(N 39),(N 77)], trans = 0},
{fin = [(N 35),(N 77)], trans = 35},
{fin = [(N 68)], trans = 0},
{fin = [(N 72),(N 77)], trans = 0},
{fin = [(N 33),(N 77)], trans = 0},
{fin = [(N 37),(N 77)], trans = 0},
{fin = [(N 47),(N 77)], trans = 0},
{fin = [(N 45),(N 77)], trans = 0},
{fin = [(N 77)], trans = 42},
{fin = [(N 62)], trans = 0},
{fin = [(N 59),(N 77)], trans = 0},
...
| 75 => (CONCAT(yypos, yypos))
| 77 => let val yytext=yymktext() in error("\n *** Lexer error: character invalid ***\n "); raise
